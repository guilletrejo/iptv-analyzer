...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Analyze a PCAP file and monitor its parameters '
                                                 + 'according to ETSI TR 101 290')
    parser.add_argument('-i', "--input", nargs='?', required=True, help='PCAP file')
